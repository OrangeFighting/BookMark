...
import com.mclab.lcc.util.DiskLruCache;
import com.mclab.lcc.util.Utils;
//import com.mclab.lcc.util.ImageCache.ImageCacheParams;
...
public class ImageCache {
    ...
    private static final int DEFAULT_DISK_CACHE_SIZE = 1024 * 1024 * 6; // 5MB
    ...
    public String createFilePathFromDiskCache(String data)
    {
    	return mDiskCache.createFilePath(data);
    }
